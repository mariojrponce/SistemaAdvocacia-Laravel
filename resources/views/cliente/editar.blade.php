            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <!-- INÍCIO: Form -->
                        <form action="{{ route('cliente.atualizar') }}" method="POST" enctype="multipart/form-data" >
                            {{csrf_field()}}
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="container-fluid text-center mb-4">
                                        <a class="flex-fill" style="font-family: 'Google Sans'; font-weight: bold; font-style: normal;"><h5>Edição</h5>
                                            ...
                                            <label for="my-input">Tipo do genero</label>
                                                ...
                                                <select name="idgenero" id="genero_id" class="form-control" required>
                                                    ...
                                                    @foreach ($generos as $genero)
                                                        <option value="{{ $genero->id }}" {{ $pessoa->idgenero == $genero->id ? 'selected' : '' }}>{{ $genero->descricao }}</option>
                                                    @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col" name="nome_col" id="nome_col_id" >
                                        <div class="form-group">
                                            ...
                                            <input id="inputNome" class="form-control rounded-pill" type="text" name="nome" value="{{$pessoa->nome}}" required>
                                        </div>
                                    </div>
                                    <div class="col" name="nascimento_col" id="nacimento_col_id">
                                        <div class="form-group">
                                            <label id="inputData">Data de nascimento':</label>
                                            <input id="inputData" type="date" name="data_nascimento" class="form-control rounded-pill"  value="{{$pessoa->data_nascimento}}"  required>
                                        </div>
                                    </div>
                                </div>
